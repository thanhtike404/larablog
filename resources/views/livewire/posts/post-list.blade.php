<div class="bg-gray-50 dark:bg-gray-900 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">Discover our latest articles and insights</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-3">
                ...
                <article
                    class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mb-6 overflow-hidden hover:shadow-md transition-shadow">
                    <div class="p-6">
                        <!-- Author info -->
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex flex-wrap gap-2 mb-3">
                                    <span
                                        class="px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300 text-xs rounded-full font-medium">
                                        {{ $post->category->name }}
                                    </span>
                                ...
                                @else
                                <p class="text-gray-600 dark:text-gray-300 mb-4 leading-relaxed">{{ Str::limit($post->getPlainTextContent(), 200) }}</p>
                                @endif
